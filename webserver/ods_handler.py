...
_LYCEES_AIM: list[tuple[str, str, str, str]] = [
    ('0131669U', 'Val Saint André', 'Aix-en-Provence', '0442271447'),
    ...
    ('0131596P', "Militaire d'Aix-en-Provence", 'Aix-en-Provence', '0442238958'),
    ...
    ('0840082H', 'Vincent de Paul', 'Avignon', '0490272390'),
    ...
    ('0131656E', "Aix-Valabre", 'Gardanne', '0442654320'),
    ...
    ('0134522V', 'HEDER KEHILA LECHEM CHAMAIM', 'Marseille', '0484188953'),
    ('0134514L', 'HAYA MOUCHKA', 'Marseille', '0491453334'),
    ('0132965C', 'Beth-Myriam', 'Marseille', '0491757104'),
    ('0134605K', 'COLLEL', 'Marseille', ''),
    ...
    ('0133554T', 'Le Rocher', 'Salon-de-Provence', '0490561379'),
    ('0132922F', 'Saint-Jean', 'Salon-de-Provence', '0490532051'),
